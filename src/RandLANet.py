...
class Network:
    ...
    def train(self, dataset):
        ...
        while self.training_epoch < self.config.max_epoch:
            ...
            try:
                ...
                log_out('Best m_IoU is: {:5.3f}'.format(max(self.mIou_list)))
    ...
    def evaluate(self, dataset):
        ...
        log_out('eval accuracy: {}'.format(val_total_correct / float(val_total_seen)))
        log_out('mean IOU:{}'.format(mean_iou))

        mean_iou = 100 * mean_iou
        log_out('Mean IoU = {:.1f}%'.format(mean_iou))
